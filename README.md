...
จากการทดลอง เมื่อทำตามขั้นตอนต่างๆ และทำการกด Ctrl+F5 จะแสดงหน้าต่างว่างๆ และเมื่อกดเมาส์จะขึ้น บอกว่าคลิกเมาไปที่ตำแหน่งแกน x และ y ที่เท่าไร

 ![](https://github.com/pronpan-08/LAB-03/blob/master/lab3joy.png?raw=true)
##คำถาม 
